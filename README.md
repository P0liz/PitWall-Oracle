...
scorecard metric, from being promoted. Ranker rows are ordered canonically and
XGBoost training is single-threaded to keep promotion decisions reproducible
between the Linux publication workflow and local Windows training.
